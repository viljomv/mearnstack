var countries=[
  ...
  for(let country of countries){
    ...
    let cntryData={counriesName,population,capitalName,currencyName}
    mycountries.push(cntryData)
    // console.log(`countryname ${counriesName} population${population}capital${capitalName}`);
   
  }
  // mycountries.map(data=>data.counriesName).forEach(names=>console.log(names))
  // for(data of mycountries){
  //   if(data.console="india"){
  //     console.log(data);
  //   }
  // }
  ...
  //print all details of india
   let indiadata=mycountries.find(data=>data.counriesName=="India")
  console.log(indiadata);
  
  let chinacurrency=mycountries.find(data=>data.counriesName=="China")
  console.log(chinacurrency);
  let populations=mycountries.filter(data=>data>20000000).population
